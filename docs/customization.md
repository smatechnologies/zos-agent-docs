...
|RESTORE-COND-CODES|YES|The z/OS Agent restores the return codes for skipped steps so that conditional processing in restarted jobs will proceed as if the full job was run.<br/><br/>Setting this parameter to "NO" will leave the skipped steps in "not run" status.|
